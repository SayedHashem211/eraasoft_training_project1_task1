                                ...
                                onTap: () {
                                  if (formUserKey.currentState!.validate()) {
                                    ...
                                    UserCubit.get(context).updateUser(
                                        nameController.text, emailController.text, phoneController.text, passwordController.text, UserCubit.get(context).buttonValueUpdate.toString() , departmentIdController.text, userStatusController.text);
                                  } else {
                                    FocusScope.of(context).unfocus();
                                  }
                                },
